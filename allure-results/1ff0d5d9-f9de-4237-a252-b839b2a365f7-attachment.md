    ...
    - generic [ref=e9]:
      ...
      - generic [ref=e16]:
        - generic [ref=e17]:
          ...
          - textbox "Username or email" [active] [ref=e21]: rajesh1781700456549@idsinternal.com
        - generic [ref=e22]:
          ...
          - link "Forgot Password?" [ref=e36] [cursor=pointer]:
            - /url: /realms/contacts-qa-us/login-actions/reset-credentials?client_id=contacts-spa&tab_id=RgO9Gk0Mxjo&client_data=eyJydSI6Imh0dHBzOi8vY29udGFjdHMtYXBwLXFhLmlkc2ludGVybmFsLmNvbS8iLCJydCI6ImNvZGUiLCJybSI6ImZyYWdtZW50Iiwic3QiOiI5ZTYzNDNkOC03ZDM0LTRkZGItOWI2MC00OTA2Y2Q4M2Y3OTUifQ
...
> 78 |         await expect(page.getByRole('heading', { name: 'Contacts' })).toBeVisible();
     |                                                                       ^ Error: expect(locator).toBeVisible() failed
  79 |        
  80 |        
  81 |         
