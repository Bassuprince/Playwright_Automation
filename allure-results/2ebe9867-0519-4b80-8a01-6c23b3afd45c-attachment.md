...
Call log:
  - waiting for getByRole('textbox', { name: 'Password' })
    - waiting for" https://contacts-keycloak-us-qa.idsinternal.com/realms/contacts-qa-us/protocol/openid-connect/auth?client_id=contacts-spa&redirect_uri=https%3A%2F%2Fcontacts-app-qa.idsinternal.com%2F&state=8479a8df-…" navigation to finish...
